...
if (process.argv.length < 7) {
 ...
 `);
    console.log(`You can't copy me Mr. Skid :L (t.me/Op_TakeDown)`);
    process.exit();
}
const headers = {};
...
const tips1 = [
    "Developed By (t.me/Op_TakeDown)",
    "Join TorVirus Network (t.me/Op_TakeDown)",
];
...
// node TorXBypassV2.js {host} {max_time} {rps} {threads} {proxy.}